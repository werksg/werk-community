    ...
    <div id="faq" className="py-6 w-full mx-auto grid grid-cols-1 md:grid-cols-2">
      ...
      <div className="">
        ...
        <div className="glass-back rounded-lg mt-6 w-3/4 min-h-[200px] p-6 flex flex-col justify-between">
          <div>
            <div className="font-bold text-xl">Still have questions?</div>
            <div className="">Unable to find the answer you are looking for? Chat with our friendly team now</div>
          </div>
          <div>
          <Link href="/Contact"><button
              class="bg-cyan-700 hover:bg-cyan-900 font-bold py-2 px-4 rounded"
              style={{ color: "white" }}
